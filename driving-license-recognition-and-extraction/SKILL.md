---
name: driving-license-recognition-and-extraction
...
能力由来也科技 [ADP（Agentic Document Processing）智能体文档处理平台](https://adp.laiye.com/?utm_source=github)提供，支持中国机动车驾驶证（正页、副页）的智能识别与关键信息抽取能力。本 Skill 调用来也科技 ADP 官方 CLI 工具，一条命令即可完成驾驶证图片/扫描件的结构化字段抽取，输出标准 JSON，无缝对接业务系统。
