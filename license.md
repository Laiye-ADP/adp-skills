...
本“Skill”（指包含模型、软件、代码、权重、文档、数据及相关衍生作品在内的整体，下称“本产品”）由来也科技（北京）有限公司（下称“许可方”）开发并拥有全部知识产权。前述衍生作品指基于本产品进行修改、整合、微调、二次开发后形成的新作品。在您（下称“被许可方”）遵守本协议条款的前提下，许可方授予您一项全球性的、免费的、非独占的许可。

1. 许可授予

1.1 免费使用与分发：许可方授予被许可方一项不可转让的、非排他性的权利，允许被许可方以非商业目的，自由地使用、复制、发布、分发本产品的副本。前述“非商业目的”包括但不限于：
•   个人学习、研究、教学、评估。
•   学术机构或开源社区内部的技术交流、非营利性项目。
•   在非商业性产品或服务中进行集成或演示。

1.2 商业许可：任何旨在直接或间接获得商业利益、收入或对价的行为（下称“商业利用”），均需获得许可方的明确书面授权（即“商业许可”）。商业利用包括但不限于：
•   以销售、转售、许可费、订阅费或其他收费形式分发本产品或基于本产品的衍生品。
•   将本产品或基于本产品的衍生品作为SaaS（软件即服务）服务向第三方提供。
•   将本产品或基于本产品的衍生品作为核心功能，集成到用于销售或租赁的软件、硬件或服务中。
•   任何以盈利为目的，利用本产品的功能或内容为第三方提供服务的行为。

2. 保留权利与所有权

2.1 本产品（包括其所有副本）的所有权、知识产权（包括但不限于著作权、专利权、商标权、商业秘密）及其他相关权益，均归许可方或其关联方所有。本协议不构成任何形式的权利转让或许可方知识产权的出售。

2.2 被许可方可在开源平台等渠道非商业分发本产品未修改副本，或进行非商业分发，需完整保留本协议、版权声明及原标识。

3. 分发条件

当被许可方分发或提供本产品时，必须满足以下全部条件：
•   保留声明：在分发副本的显著位置，完整保留本产品的所有著作权声明、本许可协议文本，以及免责声明。
•   不误导：不得暗示许可方为贵方的分发行为或修改后的版本背书。
•   标注修改：如果您对本产品进行了修改，您必须在分发时明确说明已进行修改，并注明修改日期、修改者及修改内容概要。

4. 免责声明

本产品按“现状”提供，不附带任何明示或暗示的保证，包括但不限于：许可方不保证本产品无错误、无漏洞、可正常运行、适合特定用途；许可方不保证使用本产品不会侵犯第三方权利；许可方不对被许可方或任何第三方因使用本产品导致的任何直接、间接、偶然、特殊、惩罚性损害承担责任。

5. 协议终止

5.1 本协议自被许可方首次使用本产品起生效，直至终止。
5.2 如果被许可方违反本协议第1条“许可授予”中的限制条款（例如未经授权进行商业利用），本协议将自动终止，且无需另行通知。
5.3 协议终止后，被许可方必须立即停止使用本产品，并销毁其持有的所有本产品的副本。

6. 其他

6.1 本协议的订立、执行和解释及争议的解决均应适用中华人民共和国法律。
6.2 未经许可方事先书面同意，被许可方不得转让或转移本协议下的任何权利或义务。
6.3 本协议构成双方就本许可事项达成的完整协议，并取代双方先前就此事宜达成的任何口头或书面沟通与协议。
6.4 与本协议任何相关争议，双方应友好协商解决，协商不成的，任何一方有权提交许可方注册地有管辖权的法院诉讼解决。
