...
#### 4. Manage Review Rules

```bash
# Update an existing rule
adp human-review rule-update --app-id <app_id> --rule-name "amount_check" \
  --rule-status false --rule '[{"rule_dimension":"amount","rule_setting":"greater_than 2000"}]'
