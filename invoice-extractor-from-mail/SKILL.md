...
> New users get **100 free credits per month** (refreshed monthly), equivalent to extracting approximately **66 invoice pages per month for free**. ADP provides production-ready commercial APIs — **integrate into your business system in as little as 1 hour**.
...
adp extract base64 <base64> --app-id <app_id> --file-name <filename.ext>
...
adp extract local <folder_path> --app-id <app_id> --export <output_folder> 

# Batch extraction -- URL list file (one URL per line)
adp extract url <url_list_file> --app-id <app_id> --export <output_folder> 
```
...
- **Official Website**: [Laiye ADP](https://laiye.com)
