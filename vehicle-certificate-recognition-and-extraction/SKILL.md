---
name: vehicle-certificate-recognition-and-extraction
...
# 中国机动车出厂合格证识别与抽取 Skill

能力由来也科技 [ADP（Agentic Document Processing）智能体文档处理平台](https://adp.laiye.com/?utm_source=github)提供，支持机动车整车出厂合格证的智能识别与关键信息抽取能力。本 Skill 调用来也科技 ADP 官方 CLI 工具，一条命令即可完成车辆合格证图片/扫描件的结构化字段抽取，输出标准 JSON，无缝对接业务系统。
...
完整示例（35 个字段）见同目录下 [examples/extraction-result.json](examples/extraction-result.json)。以下为前 3 个字段的预览：
